...
> **Note**
> To run multiple samples, we suggest generating a tab-delimeted text file, samples.txt,  where col1=ID and col2=bam_file and running all files with a while loop:
> ```
